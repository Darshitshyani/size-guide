  ...
  male: [
    {
      ...
      howToMeasure: [
        { title: "Waist", description: "Wrap the tape around the narrowest part of your waist." },
        { title: "Hip", description: "Measure around the widest part of your hips." },
        { title: "Inseam", description: "Measure from the crotch seam down to the bottom of the leg." }
      ]
    },
    {
      id: "shirts",
      ...
      howToMeasure: [
        { title: "Chest", description: "Measure around the fullest part of your chest." },
        { title: "Shoulder", description: "Measure from the tip of one shoulder to the other." },
        { title: "Length", description: "Measure from the highest shoulder point down." }
      ]
    },
    {
      id: "tshirt",
    ...
    },
    {
      ...
      sizeChart: {
        ...
        rows: [
          ...
          { size: "M", chest: 40, shoulder: 17.5, length: 41 },
          { size: "L", chest: 42, shoulder: 18, length: 42 },
          { size: "XL", chest: 44, shoulder: 18.5, length: 43 },
          { size: "XXL", chest: 46, shoulder: 19, length: 44 }
        ]
      },
      howToMeasure: [
        { title: "Chest", description: "Measure around the fullest part of your chest." },
    ...
    },
    {
      ...
      sizeChart: {
        ...
        rows: [
          { size: "S", chest: 38, waist: 30, shoulder: 17, length: 40 },
          { size: "M", chest: 40, waist: 32, shoulder: 17.5, length: 41 },
          { size: "L", chest: 42, waist: 34, shoulder: 18, length: 42 },
          { size: "XL", chest: 44, waist: 36, shoulder: 18.5, length: 43 },
          { size: "XXL", chest: 46, waist: 38, shoulder: 19, length: 44 }
        ]
      },
      howToMeasure: [
        { title: "Chest", description: "Measure around the fullest part of your chest." },
    ...
    },
    {
      ...
      sizeChart: {
        columns: [
          { label: "Size (India)", key: "size" },
          { label: "Foot Length (cm)", key: "length" }
        ],
        rows: [
          { size: 6, length: 24 },
          { size: 7, length: 25 },
      ...
      howToMeasure: [
        { title: "Foot Length", description: "Measure from the tip of the longest toe to the back of the heel." }
      ]
    }
  ],
  female: [
    ...
    },
    {
      ...
      sizeChart: {
        columns: [
          { label: "Size", key: "size" },
          { label: "Bust (in)", key: "bust" },
          { label: "Waist (in)", key: "waist" },
          { label: "Hip (in)", key: "hip" }
        ],
        rows: [
          { size: "S", bust: 34, waist: 27, hip: 36 },
          { size: "M", bust: 36, waist: 29, hip: 38 },
          { size: "L", bust: 38, waist: 31, hip: 40 },
          { size: "XL", bust: 40, waist: 33, hip: 42 },
          { size: "XXL", bust: 42, waist: 35, hip: 44 }
        ]
      },
      howToMeasure: [
        { title: "Bust", description: "Measure around the fullest part of your bust." },
        { title: "Waist", description: "Measure around the narrowest part of your waist." },
        { title: "Hip", description: "Measure around the widest part of your hips." }
      ]
    },
    {
      ...
      sizeChart: {
        ...
        rows: [
          { size: 28, waist: 28, hip: 35, inseam: 32 },
    ...
    },
    {
      ...
      sizeChart: {
        ...
        rows: [
          { size: "S", waist: 28, hip: 36 },
          { size: "M", waist: 30, hip: 38 },
          { size: "L", waist: 32, hip: 40 },
          { size: "XL", waist: 34, hip: 42 },
          { size: "XXL", waist: 36, hip: 44 }
        ]
      },
      howToMeasure: [
        { title: "Waist", description: "Measure around the narrowest part of your waist." },
    ...
    },
    {
      ...
      sizeChart: {
        columns: [
          ...
          { label: "Waist (in)", key: "waist" },
          { label: "Hip (in)", key: "hip" },
          { label: "Top Length (in)", key: "topLength" }
        ],
        rows: [
          { size: "S", bust: 34, waist: 28, hip: 36, topLength: 41 },
          { size: "M", bust: 36, waist: 30, hip: 38, topLength: 42 },
          { size: "L", bust: 38, waist: 32, hip: 40, topLength: 43 },
          { size: "XL", bust: 40, waist: 34, hip: 42, topLength: 44 },
          { size: "XXL", bust: 42, waist: 36, hip: 44, topLength: 45 }
        ]
      },
      howToMeasure: [
        { title: "Bust", description: "Measure around the fullest part of your bust." },
        { title: "Waist", description: "Measure around the narrowest part of your waist." },
        { title: "Hip", description: "Measure around the widest part of your hips." },
        { title: "Top Length", description: "Measure from the highest shoulder point down to the hem of the top." }
      ]
    },
    {
      id: "saree",
    ...
    },
    {
      ...
      sizeChart: {
        columns: [
          { label: "Band Size", key: "band" },
          { label: "Cup Size", key: "cup" },
          { label: "Bust (in)", key: "bust" }
        ],
        rows: [
          { band: 32, cup: "B", bust: 34 },
          { band: 34, cup: "B", bust: 36 },
          { band: 36, cup: "C", bust: 38 },
          { band: 38, cup: "C", bust: 40 }
        ]
      },
      howToMeasure: [
        { title: "Band Size", description: "Measure around your ribcage directly under your bust." },
        { title: "Cup Size", description: "Measure around the fullest part of your bust." }
      ]
    },
    {
      id: "underwear",
      label: "Underwear",
      icon: FemaleUnderwear,
      sizeChart: {
        columns: [
          { label: "Size", key: "size" },
          { label: "Waist (in)", key: "waist" }
