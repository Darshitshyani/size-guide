      ...
      <div className="w-full h-screen flex flex-col bg-white overflow-hidden">
        ...
        <div className="p-4 flex flex-col flex-1 overflow-hidden">
          ...
          <div className="flex gap-2 mb-3 flex-shrink-0 p-1 bg-gray-100 w-fit rounded-xl border border-gray-300">
            <button
              className={`px-4 py-3 font-semibold text-xs cursor-pointer border-none  text-gray-600  transition-all duration-200 relative ${
                activeTab === "products" 
                      ...
                      <div className="flex gap-2 flex-wrap">
                        {["All", "Active", "Not Active", "Not Assigned"].map((status) => (
                          <button
                            ...
                            className={`px-4 py-1.5 text-[12px] font-medium cursor-pointer rounded-full transition-colors ${
                              tableChartStatus === status
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="flex items-center gap-4">
                      <div>
                        <h3 className="text-base font-semibold text-gray-900 mb-2">Chart 4</h3>
                        <div className="flex gap-2 flex-wrap">
                          <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-700 rounded-full">Male</span>
                          <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-700 rounded-full">tshirt</span>
                          <span className="px-3 py-1 text-xs font-medium bg-red-100 text-red-600 rounded-full">Inactive</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <button
                        type="button"
                        className="flex items-center gap-1 px-3 py-1.5 text-sm font-medium bg-white text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 transition-colors"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                      ...
                      <button
                        type="button"
                        className="flex items-center gap-1 px-3 py-1.5 text-sm font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
                      >
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="flex items-center gap-4">
                      <div>
                        <h3 className="text-base font-semibold text-gray-900 mb-2">Chart 2</h3>
                        <div className="flex gap-2 flex-wrap">
                          <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-700 rounded-full">Male</span>
                          <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-700 rounded-full">pants</span>
                          <span className="px-3 py-1 text-xs font-medium bg-red-100 text-red-600 rounded-full">Inactive</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="flex items-center gap-4">
                      <div>
                        <h3 className="text-base font-semibold text-gray-900 mb-2">Chart 1</h3>
                        <div className="flex gap-2 flex-wrap">
                          <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-700 rounded-full">Male</span>
                          <span className="px-3 py-1 text-xs font-medium bg-gray-100 text-gray-700 rounded-full">tshirt</span>
                          <span className="px-3 py-1 text-xs font-medium bg-red-100 text-red-600 rounded-full">Inactive</span>
