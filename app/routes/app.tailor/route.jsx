                ...
                if (accessKeyId && secretAccessKey && region && bucketName) {
                    ...
                    for (const imageUrl of userUploadedImages) {
                        try {
                            ...
                            // or: https://bucket.s3.region.amazonaws.com/images/uploads/filename
            ...
            <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 text-sm font-medium rounded-md flex items-center gap-2 ${fetcher.state !== "idle"
