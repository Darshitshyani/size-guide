...
CREATE TABLE "new_SizeChartSettings" (
    ...
    "customOrderButtonText" TEXT NOT NULL DEFAULT 'Custom Order',
    "customOrderButtonIcon" TEXT NOT NULL DEFAULT 'ruler',
    "customOrderButtonTextColor" TEXT NOT NULL DEFAULT '#ffffff',
    "customOrderButtonBgColor" TEXT NOT NULL DEFAULT '#111111',
    "customOrderButtonBorderRadius" INTEGER NOT NULL DEFAULT 6,
    "customOrderButtonBorderStyle" TEXT NOT NULL DEFAULT 'none',
    "customOrderButtonBorderColor" TEXT NOT NULL DEFAULT '#111111',
    "customOrderButtonBorderWidth" INTEGER NOT NULL DEFAULT 1,
    "customOrderButtonBorderTop" BOOLEAN NOT NULL DEFAULT true,
    "customOrderButtonBorderRight" BOOLEAN NOT NULL DEFAULT true,
    "customOrderButtonBorderBottom" BOOLEAN NOT NULL DEFAULT true,
    "customOrderButtonBorderLeft" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_SizeChartSettings" ("buttonAlignment", "buttonBgColor", "buttonBorderBottom", "buttonBorderColor", "buttonBorderLeft", "buttonBorderRadius", "buttonBorderRight", "buttonBorderStyle", "buttonBorderTop", "buttonBorderWidth", "buttonIcon", "buttonPaddingBottom", "buttonPaddingLeft", "buttonPaddingRight", "buttonPaddingTop", "buttonText", "buttonTextColor", "createdAt", "id", "shop", "tableDesign", "updatedAt") SELECT "buttonAlignment", "buttonBgColor", "buttonBorderBottom", "buttonBorderColor", "buttonBorderLeft", "buttonBorderRadius", "buttonBorderRight", "buttonBorderStyle", "buttonBorderTop", "buttonBorderWidth", "buttonIcon", "buttonPaddingBottom", "buttonPaddingLeft", "buttonPaddingRight", "buttonPaddingTop", "buttonText", "buttonTextColor", "createdAt", "id", "shop", "tableDesign", "updatedAt" FROM "SizeChartSettings";
